...
def main():
    parser = argparse.ArgumentParser(description='SecretCoded - Advanced Steganography Tool', epilog="Example commands:\n"
                                            "  Hide: python secret_coded.py hide host.png secret.txt mypublickey.pem output.png\n"
                                            "  Extract: python secret_coded.py extract carrier.png myprivatekey.pem [extracted.txt]",
                                     formatter_class=argparse.RawDescriptionHelpFormatter)
    subparsers = parser.add_subparsers(dest='command')

    # Subparser for hiding a file
    hide_parser = subparsers.add_parser('hide', help='Hide a file inside an image', epilog="Example: python secret_coded.py hide host.png secret.txt mypublickey.pem output.png", formatter_class=argparse.RawDescriptionHelpFormatter)
    ...
    extract_parser = subparsers.add_parser('extract', help='Extract a file from an image', epilog="Example: python secret_coded.py extract carrier.png  myprivatekey.pem [extracted.txt]",
                                           formatter_class=argparse.RawDescriptionHelpFormatter)
